...
extern "C" {
    ...
    // desktop renderer
    JNIEXPORT jboolean JNICALL FN_DESKTOP(nAttachDesktopSurface)(JNIEnv *env, jclass clazz, jlong ptr, jlong windowHandle);
    JNIEXPORT jboolean JNICALL FN_DESKTOP(nDetachDesktopSurface)(JNIEnv *env, jclass clazz, jlong ptr);
...
JNIEXPORT jboolean JNICALL FN_DESKTOP(nAttachDesktopSurface)(JNIEnv *env, jclass clazz, jlong ptr, jlong windowHandle) {
    auto* instance = reinterpret_cast<mediampv::mpv_handle_t *>(static_cast<uintptr_t>(ptr));
    return instance->attach_desktop_surface(windowHandle);
}

JNIEXPORT jboolean JNICALL FN_DESKTOP(nDetachDesktopSurface)(JNIEnv *env, jclass clazz, jlong ptr) {
    auto* instance = reinterpret_cast<mediampv::mpv_handle_t *>(static_cast<uintptr_t>(ptr));
    return instance->detach_desktop_surface();
}
